...
export const genres = [`Musical`, `Western`, `Drama`, `Comedy`, `Cartoon`, `Film-Noir`, `Mystery`];
...
export const ageRatings = [`18+`, `16+`, `12+`, `6+`, `0+`];

export const productionYears = [`1929`, `1933`, `1955`, `1964`, `1936`];
